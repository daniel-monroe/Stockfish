...
inline int non_pawn_index(const Position& pos) {
    return pos.non_pawn_key(c) & ((T == Normal ? PAWN_HISTORY_SIZE : CORRECTION_HISTORY_SIZE) - 1);
}
...
using PawnHistory = Stats<int16_t, 8192, 4, PAWN_HISTORY_SIZE, PIECE_NB, SQUARE_NB>;
