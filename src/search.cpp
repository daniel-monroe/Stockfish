        ...
        if (!rootNode && pos.non_pawn_material(us) && !is_loss(bestValue))
        {
            ...
            else
            {
                int history =
                  ...
                  + thisThread->pawnHistory[pawn_structure_index(pos)][movedPiece][move.to_sq()] + 3 * std::max(thisThread->pawnHistory[pawn_structure_index(pos)][movedPiece][move.to_sq()] - 4000, 0);
