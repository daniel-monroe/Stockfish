...
void Search::Worker::iterative_deepening() {
           ...
           && !(limits.depth && mainThread && rootDepth > limits.depth))
    {
        ...
        if (limits.use_time_management() && !threads.stop && !mainThread->stopOnPonderhit)
        {
            ...
            double tttm1  = double(1185) / 100;
            double tttm2  = double(224) / 100;
            double tttm3  = double(93) / 100;
            double tttm4  = double(57) / 100;
            double tttm5  = double(170) / 100;
            double tttm6  = double(51) / 100;
            double tttm7  = double(1215) / 100;
            double tttm8  = double(66) / 100;
            double tttm9  = double(85) / 100;
            double tttm10 = double(98) / 100;
            double tttm11 = double(143) / 100;
            double tttm12 = double(228) / 100;
            double tttm13 = double(102) / 100;
            double tttm14 = double(214) / 100;
            double tttm15 = double(75) / 100;
            double tttm16 = double(50) / 100;
            ...
            double highBestMoveEffort = completedDepth >= 10 && nodesEffort >= 93337 ? tttm15 : 1.0;
