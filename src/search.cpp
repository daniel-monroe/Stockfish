...
int rmuls[5] = {1024, 1024, 1024, 1024, 1024};
TUNE(rmuls);
...
moves_loop:  // When in check, search starts here
    ...
    while ((move = mp.next_move()) != Move::none())
    {
        ...
        auxR = auxR * rmuls[std::clamp(depth / 4, 0, 4)] / 1024;
